...
@Global()@Module({imports:[MongooseModule.forFeature([{name:RegionalDataRecord.name,schema:RegionalDataRecordSchema}])],providers:[LocationReviewService,BusinessRegistrationService,RegionalDataService,AdminTokenGuard],controllers:[AdminRegionsController,AdminLocationReviewController,BusinessRegistrationController,RegionalDataController],exports:[LocationReviewService,RegionalDataService,AdminTokenGuard]})export class RegionalDataModule{}
