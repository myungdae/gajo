...
export const GUIDE_KNOWLEDGE: GuideKnowledge[] = [
  ...
  item({
    ...
    shortAnswer:
      '합천에서 현장 검증을 진행했고, 가조에서 공통 엔진의 재사용성을 확인했으며, 옥천도 같은 Regional Engine에 공식 지역 데이터와 설정을 연결하는 방식으로 온보딩하고 있습니다. 현재 옥천 방문자 화면과 지역별 여행 저장, 공식 관광·음식·숙박·체험 데이터의 기본 연결은 구현되어 있지만, 일부 장소의 정확한 좌표와 운영시간, 카페·생활편의점의 현장 검증은 계속 필요합니다. 따라서 공개 배포가 완료된 완전한 운영 서비스라고 주장하지는 않습니다.',
    supportingConcepts: [
