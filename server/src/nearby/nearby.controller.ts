...
const CATEGORIES: NearbyCategory[] = ['FOOD', 'CAFE', 'LODGING', 'HOT_SPRING_WELLNESS', 'GOLF_SCREEN_GOLF', 'ACTIVITY', 'TOURISM_NATURE', 'CONVENIENCE', 'ESSENTIAL_SHOPPING', 'CONVENIENCE_STORE', 'MART_SUPERMARKET', 'PARKING', 'PUBLIC_TOILET', 'GAS_STATION', 'PHARMACY', 'HOSPITAL', 'ATM', 'OTHER'];
