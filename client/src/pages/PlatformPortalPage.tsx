...
const differenceQuestions = [
  ...
  { question: 'ChatGPT에 여행 일정을 물으면 되지 않나요?', answer: '기존 GPT는 질문하면 답을 주는 범용 AI입니다. 합천 AI는 내 위치와 여행 상황에 맞춰 지금 갈 곳을 찾아줍니다. 추천에서 끝나지 않고 전화·지도·길찾기까지 이어주는 현장형 AI 여행동행자입니다.' },
