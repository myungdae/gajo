...
export const VOICE_COPY = {
  ko: {
    ...
    states:{IDLE:'말로 질문하기',REQUESTING_PERMISSION:'마이크 사용을 확인하고 있어요',LISTENING:'듣고 있어요. 말씀해 주세요.',TRANSCRIBING:'인식 문장을 정리하고 있어요',UNDERSTANDING:'인식 문장을 확인하고 있어요',CONFIRMING:'듣기가 끝났어요. 인식된 문장을 확인해 주세요.',EXECUTING:'전송 중…',RECOVERABLE_ERROR:'다시 말하거나 글자로 입력할 수 있어요',PERMISSION_DENIED:'마이크 권한이 거부되었습니다',UNSUPPORTED:'글자로 계속 질문할 수 있어요'},
  },
  en: {
    ...
    states:{IDLE:'Speak a Question',REQUESTING_PERMISSION:'Checking microphone access',LISTENING:'Listening. Please speak.',TRANSCRIBING:'Preparing recognized text',UNDERSTANDING:'Checking recognized text',CONFIRMING:'Listening finished. Review your recognized text.',EXECUTING:'Sending…',RECOVERABLE_ERROR:'Speak again or type your question',PERMISSION_DENIED:'Microphone permission denied',UNSUPPORTED:'You can continue by typing'},
  },
} as const;
