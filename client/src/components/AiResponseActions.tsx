...
export default function AiResponseActions({ rawMessage, result, turnId, excludedEntityIds, onExcludedEntityIdsChange }: { rawMessage: string; result: ConciergeChatResponse; turnId: string; excludedEntityIds?: string[]; onExcludedEntityIdsChange?: (ids: string[]) => void }) {
