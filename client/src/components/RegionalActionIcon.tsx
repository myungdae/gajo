...
export type RegionalHomeActionType = "FOOD" | "CAFE" | "ACCOMMODATION" | "NEXT_PLACE" | "EVENT_TODAY" | "COMPANION_FRIENDLY";
...
const paths: Record<RegionalHomeActionType, ReactNode> = {
  ...
  ACCOMMODATION: <><path d="M3.5 20V9.5h17V20M3.5 16h17M6.5 9.5V6h5a3 3 0 0 1 3 3v.5"/><path d="M3.5 13H2.5M20.5 13h1"/></>,
