...
export default function ExkoRegionKnowledgeLink({regionId,compact=false}:{regionId:string;compact?:boolean}) {
  ...
  if(compact)return <div className="exko-region-knowledge-compact"><small>EXKO 지역지식: 살펴보기 가능</small><a href={url} target="_blank" rel="noopener noreferrer">EXKO에서 {name}군 먼저 살펴보기 <span aria-hidden="true">↗</span></a></div>;
