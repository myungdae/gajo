...
export default function VisitorLocationControl({onLocation}:{onLocation?:(location:VisitorLocation)=>void}){
  ...
  return <div className="visitor-location-control">
    ...
    {isOperationalLocation(location)&&<><p><b>현재 위치 확인됨</b> · 이곳을 기준으로 가까운 곳을 찾아드릴게요.</p><details><summary>위치 자세히</summary><p>정확도 약 {Math.round(location!.accuracy||0)}m · {confidence}</p></details></>}
