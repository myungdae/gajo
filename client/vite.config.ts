...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      injectManifest: {
        ...
        globIgnores: ['**/copilot.html','**/guide.html','**/portal.html','**/exkovia.html','**/regional-hapcheon-entry.html','**/unsupported.html'],
      },
    }),
  ],
  server: {
  ...
  build:{rollupOptions:{input:{visitor:resolve(__dirname,'index.html'),exkovia:resolve(__dirname,'exkovia.html'),hapcheonEntry:resolve(__dirname,'regional-hapcheon-entry.html'),unsupported:resolve(__dirname,'unsupported.html'),copilot:resolve(__dirname,'copilot.html'),guide:resolve(__dirname,'guide.html'),portal:resolve(__dirname,'portal.html')}}},
});
